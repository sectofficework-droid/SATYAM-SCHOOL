...
// ── Main Component ─────────────────────────────────────────────
// variant: "page" (standalone /student/add page) | "modal" (popup from Student Management)
export default function AddStudentForm({ variant = "page", onCancel, onSaved }) {
  ...
  return (
    <div className={isModal ? "flex flex-col max-h-[92vh]" : "max-w-6xl mx-auto space-y-6 pb-10"}>
      ...
      <form
        ...
        className={isModal ? "space-y-6 px-6 py-6 overflow-y-auto" : "space-y-6"}
      >
