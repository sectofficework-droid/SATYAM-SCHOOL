...
class TeacherRulesPage extends StatefulWidget {
  final bool embedded;
  const TeacherRulesPage({super.key, this.embedded = false});
  @override
  State<TeacherRulesPage> createState() => _TeacherRulesPageState();
}

class _TeacherRulesPageState extends State<TeacherRulesPage> {
  String _content = '';
  bool _loading = true;
