...
// Shared startup for both the Teacher and Student flavor builds - each entry
// point (main_teacher.dart / main_student.dart) sets the locked role and
// passes in its own role-only GetPage list before calling this, so the two
// apps share every bit of init/session/theme logic without duplicating it.
Future<void> runSatyamApp({
...
class SatyamSchoolApp extends StatefulWidget {
  ...
  const SatyamSchoolApp({super.key, required this.pages});
